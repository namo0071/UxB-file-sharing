...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7532569959:AAGXOVhV7GsO5DZEPP1FJ38osqNZ4LqEPk8")
...
FORCESUB_CHANNEL = int(os.environ.get("FORCESUB_CHANNEL", "-1002480034223"))
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1002449302902"))
FORCESUB_CHANNEL3 = int(os.environ.get("FORCESUB_CHANNEL3", "-1002445629338"))
...
TUT_VID = os.environ.get("TUT_VID","https://t.me/m2manju/2")
